...
public class JavaBasicJoinCsv {
	...
	public static class ParseLine implements PairFunction<String, Integer, String[]> {
		...
		public Tuple2<Integer, String[]> call(String line) throws Exception {
			...
			reader.close();
			return new Tuple2<Integer, String[]>(key, elements);
		}
	}
	...
	public void run(String master, String csv1, String csv2) throws Exception {
		JavaSparkContext sc = new JavaSparkContext(master, "basicjoincsv", System.getenv("SPARK_HOME"),
				System.getenv("JARS"));
		...
		for (Tuple2<Integer, Tuple2<String[], String[]>> a : resultCollection)
			System.out.println("CIAO: " + a._1 + " " + Arrays.toString(a._2._1) + " " + Arrays.toString(a._2._2));
